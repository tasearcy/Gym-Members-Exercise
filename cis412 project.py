# -*- coding: utf-8 -*-
"""
Created on Sun Nov 23 14:58:00 2025
...
df = pd.read_csv(r"C:\Users\user\Desktop\Programming\gym_members_exercise_tracking.csv")
print(df.head())
...
plt.xlabel('Intensity (Avg_BPM × Duration)')
plt.ylabel('Calories Burned')
plt.tight_layout()
